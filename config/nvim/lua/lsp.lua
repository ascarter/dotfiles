...
-- Definitions live in lsp/*.lua, but this user configuration never installs
-- language servers. Enable only commands already supplied by the environment,
-- normally through the current project's mise configuration.
local servers = {
